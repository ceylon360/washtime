                        ...
                        <table cellspacing="0">
                            ...
                            <tr>
                                <td class="control-group">
                                    <label for="ab-staff-wpuser"><?php _e( 'User', 'ab') ?></label>
                                    <div class="controls">
                            ...
                            <tr class="form-required">
                                <td class="control-group">
                                    <label for="ab-staff-full-name"><?php _e( 'Full name', 'ab') ?></label>
                                    <div class="controls">
                                        <input class="form-control" id="ab-staff-full-name" name="full_name" value="<?php echo esc_attr($staff->get('full_name')) ?>" type="text"/>
                                    </div>
                                </td>
                                <td style="vertical-align: bottom"><span class=" ab-red"> *</span></td>
                            </tr>
                            <tr>
                                <td class="control-group">
                                    <label for="ab-staff-email"><?php _e( 'Email', 'ab') ?></label>
                                    <div class="controls">
                            ...
                            <tr>
                                <td class="control-group">
                                    <label for="ab-staff-phone"><?php _e( 'Phone', 'ab') ?></label>
                                    <div class="controls">
                            ...
                            <tr>
                                <td class="control-group">
                                    <label for="ab-calendar-id"><?php _e( 'Calendar ID', 'ab' ) ?></label>
                                    <div class="controls">
