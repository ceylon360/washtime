...
<form enctype="multipart/form-data" method="post" action="<?php echo esc_url( add_query_arg( 'type', '_woocommerce' ) ) ?>" class="ab-settings-form" id="woocommerce">
    ...
    <table class="form-horizontal">
        ...
        <tr>
            <td colspan="2">
                <select class="form-control" name="ab_woocommerce" style="width: 125px;">
        ...
        <tr>
            <td colspan="2"><input class="form-control" type="text" name="ab_woocommerce_cart_info_name" value="<?php echo esc_attr( get_option( 'ab_woocommerce_cart_info_name' ) ) ?>" placeholder="<?php echo esc_attr( __( 'Enter a name', 'ab' ) ) ?>" /></td>
        </tr>
        <tr>
            <td colspan="2">
                <textarea class="form-control" rows="8" name="ab_woocommerce_cart_info_value" style="width: 100%" placeholder="<?php _e( 'Enter a value','ab' ) ?>"><?php echo esc_textarea( get_option( 'ab_woocommerce_cart_info_value' ) ) ?></textarea>
            </td>
        </tr>
