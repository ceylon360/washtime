...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php _e( 'SMS Notifications', 'ab' ) ?></h3>
    </div>
    <div class="panel-body">
        <div class="ab-wrapper-container">
            ...
            <?php if ( $is_logged_in ): ?>
                ...
                <div class="form-inline">
                    <div class="row">
                        <div class="col-md-6 text-left">
                            <?php _e( 'Your balance', 'ab' ) ?>:
                            <span>$<?php echo $sms->getBalance() ?></span>
                        </div>
                        <div class="col-md-6 text-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#modal_change_password"><?php _e( 'Change password', 'ab' ) ?></a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
                                        <a href="javascript:void(0)">
                                            <form class="" method="post">
                                                <button type="submit" name="form-logout" class="ab-logout"><?php _e( 'Log out', 'ab' ) ?></button>
                                            </form>
                                        </a>
                                    </li>
                                </ul>
                ...
                <div>
                    <ul class="nav nav-tabs" id="sms_tabs">
                        <li class=""><a data-toggle="tab" href="#notifications"><?php _e( 'Notifications', 'ab' ) ?></a></li>
                        <li class=""><a data-toggle="tab" href="#add_money"><?php _e( 'Add money', 'ab' ) ?></a></li>
                        <li class=""><a data-toggle="tab" href="#purchases"><?php _e( 'Purchases', 'ab' ) ?></a></li>
                        <li class=""><a data-toggle="tab" href="#sms_details"><?php _e( 'SMS Details', 'ab' ) ?></a></li>
                        <li class=""><a data-toggle="tab" href="#price"><?php _e( 'Price list', 'ab' ) ?></a></li>
                    </ul>
            ...
            <?php else: ?>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="alert alert-info"><?php _e( 'SMS Notifications (or "Bookly SMS") is a service for notifying your customers via text messages which are sent to mobile phones.<br/>It is necessary to register in order to start using this service.<br/>After registration you will need to configure notification messages and top up your balance in order to start sending SMS.', 'ab' ) ?></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-3">
                        <form method="post" class="ab-login-form well">
                            ...
                            <fieldset>
                                <legend><?php _e( 'Login', 'ab' ) ?></legend>
                                <div class="form-group">
                                    <label for="ab_username"><?php _e( 'Email', 'ab' ) ?></label>
                                    <input id="ab_username" class="form-control" type="text" required="required" value="" name="username"/>
                                </div>
                                <div class="form-group">
                                    <label for="ab_password"><?php _e( 'Password', 'ab' ) ?></label>
                                    <input id="ab_password" class="form-control" type="password" required="required" name="password"/>
                                </div>
                                <div class="form-group">
                                    <button type="submit" name="form-login" class="btn btn-info"><?php _e( 'Log in', 'ab' ) ?></button>
                                    <a href="#" class="show-register-form"><?php _e( 'Registration', 'ab' ) ?></a>
                                    <a href="#" class="show-forgot-form"><?php _e( 'Forgot password', 'ab' ) ?></a>
                                </div>
                            </fieldset>
                        ...
                        <form method="post" class="ab-register-form well" style="display: none;">
                            <fieldset>
                                <legend><?php _e( 'Registration', "ab" ) ?></legend>
                                <div class="form-group">
                                    <label for="ab_r_username"><?php _e( 'Email', 'ab' ) ?></label>
                                    <input id="ab_r_username" name="username" class="form-control" required="required" value="" type="text" />
                                </div>
                                <div class="form-group">
                                    <label for="ab_r_password"><?php _e( 'Password', 'ab' ) ?></label>
                                    <input id="ab_r_password" name="password" class="form-control" required="required" value="" type="password" />
                                </div>
                                <div class="form-group">
                                    <label for="ab_r_repeat_password"><?php _e( 'Repeat password', 'ab' ) ?></label>
                                    <input id="ab_r_repeat_password" name="password_repeat" class="form-control" required="required" value="" type="password" />
                                </div>
                                <div class="form-group">
                                    <label for="ab_r_tos"><?php _e( 'Accept <a href="javascript:void(0)" data-toggle="modal" data-target="#ab-tos">Terms & Conditions</a>', 'ab' ) ?></label>
                                    <input id="ab_r_tos" name="accept_tos" class="form-control" required="required" value="1" type="checkbox" style="margin:0" />
                                </div>

                                <div class="form-group">
                                    <button type="submit" name="form-registration" class="btn btn-info"><?php _e( 'Register', 'ab' ) ?></button>
                                    <a href="#" class="show-login-form"><?php _e( 'Login', 'ab' ) ?></a>
                                </div>
                            </fieldset>
                        </form>
                        ...
                        <form method="post" class="ab-forgot-form well" style="display: none;">
                            <fieldset>
                                <legend><?php _e( 'Forgot password', "ab" ) ?></legend>
                                <div class="form-group">
                                    <input name="username" class="form-control" value="" type="text" placeholder="<?php echo esc_attr( __( 'Email', 'ab' ) ) ?>" />
                                </div>
                                <div class="form-group hidden">
                                    <input name="code" class="form-control" value="" type="text" placeholder="<?php echo esc_attr( __( 'Enter code from email', 'ab' ) ) ?>" />
                                </div>
                                <div class="form-group hidden">
                                    <input name="password" class="form-control" value="" type="password" placeholder="<?php echo esc_attr( __( 'New password', 'ab' ) ) ?>" />
                                </div>
                                <div class="form-group hidden">
                                    <input name="password_repeat" class="form-control" value="" type="password" placeholder="<?php echo esc_attr( __( 'Repeat new password', 'ab' ) ) ?>" />
                                </div>
                                <div class="form-group">
                                    <button class="btn btn-info form-forgot-next" data-step="0"><?php _e( 'Next', 'ab' ) ?></button>
                                    <a href="#" class="show-login-form"><?php _e( 'Login', 'ab' ) ?></a>
                                </div>
                            </fieldset>
                        </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php _e( 'Change password', 'ab' ) ?></h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="old_password"><?php _e( 'Old password', 'ab' ) ?></label>
                    <input type="password" class="form-control" id="old_password" name="old_password" placeholder="<?php echo esc_attr( __( 'Old password', 'ab' ) ) ?>">
                </div>
                <div class="form-group">
                    <label for="new_password"><?php _e( 'New password', 'ab' ) ?></label>
                    <input type="password" class="form-control" id="new_password" name="new_password" placeholder="<?php echo esc_attr( __( 'New password', 'ab' ) ) ?>">
                </div>
                <div class="form-group">
                    <label for="new_password_repeat"><?php _e( 'Repeat new password', 'ab' ) ?></label>
                    <input type="password" class="form-control" id="new_password_repeat" placeholder="<?php echo esc_attr( __( 'Repeat new password', 'ab' ) ) ?>">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-info" id="submit_change_password"><?php _e( 'Save', 'ab' ) ?></button>
                <button type="button" class="ab-reset-form" data-dismiss="modal"><?php _e( 'Cancel', 'ab' ) ?></button>
            </div>
...
<div class="modal fade" id="ab-tos">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><?php _e( 'Terms & Conditions', 'ab' ) ?></h4>
            </div>
            <div class="modal-body">
