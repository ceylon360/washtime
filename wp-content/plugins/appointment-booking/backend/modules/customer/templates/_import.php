...
<div id="ab_import_customers_dialog" class="modal fade" tabindex=-1 role="dialog" aria-labelledby="importCustomersModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo AB_CommonUtils::escAdminUrl( AB_CustomerController::page_slug ) ?>" method="POST">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><?php _e( 'Import', 'ab' ) ?></h4>
                </div>
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            <label><?php _e( 'Note' , 'ab' ) ?></label>
                            <?php _e( 'You may import list of clients in CSV format. The file needs to have three columns: Name, Phone and Email.' , 'ab' ) ?>
                        </div>
                        <div class="form-group">
                            <label for="import_customers_file"><?php _e( 'Select file' , 'ab' ) ?></label>
                            <input name="import_customers_file" id="import_customers_file" type="file">
                        </div>
                        <div class="form-group">
                            <label for="import_customers_delimiter"><?php _e( 'Delimiter' , 'ab' ) ?></label>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-info ab-popup-save ab-update-button"><?php echo esc_attr( __( 'Import' , 'ab' ) ) ?></button>
