...
<style type="text/css">
    /* Service */
    .ab-label-error {color: <?php echo $color ?>!important;}
    ...
    div.ab-error select {border: 2px solid <?php echo $color ?>!important;}
    ...
    .picker--focused .picker__day--selected {color: <?php echo $color ?>!important;}
    .picker--focused .picker__day--highlighted {color: <?php echo $color ?>!important;}
