<div class="booked-settings-wrap wrap">
	...
	<div id="booked-admin-panel-container">
		...
		<ul class="booked-admin-tabs bookedClearFix">
			<li class="active"><a href="#general"><i class="fa fa-gear"></i>&nbsp;&nbsp;<?php _e('General','booked'); ?></a></li>
		...
		<div class="form-wrapper">
			...
			<form action="options.php" method="post">
				...
				<div id="booked-general" class="tab-content">
					...
					<div class="section-row">
						<div class="section-head">
							<?php $section_title = __('Instant Profile Page', 'booked'); ?>
					...
					<div class="section-row">
						<div class="section-head">
							...
							<div class="select-box">
								<select name="<?php echo $option_name; ?>">
									<option value=""><?php _e('Redirect to the chosen Profile page','booked'); ?></option>
									<?php if(!empty($pages)) :
										foreach($pages as $p) :
											$entry_id = $p->ID;
											$entry_title = get_the_title($entry_id); ?>
					...
					<div class="section-row cf">
						<div class="section-head">
							...
							<label class="checkbox-radio-label" for="<?php echo $option_name; ?>"><?php _e('Hide end times on front-end (show only start times)','booked'); ?></label>
				...
				<div id="booked-user-emails" class="tab-content">
					...
					<div class="section-row">
						<div class="section-head">
							<?php $section_title = __('Which user should receive notification emails by default?', 'booked'); ?>
							<h3><?php echo esc_attr($section_title); ?></h2>
									...
									?><div class="booked-customTimeslot">
										...
										<?php if (!empty($calendars)):
											...
											echo '<select name="booked_custom_calendar_id">';
												echo '<option value="">'.__('Default Calendar','booked').'</option>';
			...
			<div id="booked-shortcodes" class="tab-content">
				...
				<div class="section-row" style="margin-bottom:-50px;">
					<div class="section-head">
						...
						<p><?php _e('You can use this shortcode to display the front-end booking calendar.','booked'); ?></p>
